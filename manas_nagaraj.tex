...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://manasnagaraj.com/}{\Large Manas Nagaraj}} & Email: \href{mailto:manasnagaraj@gmail.com}{manasnagaraj@gmail.com}\\
  \href{https://manasnagaraj.com/}{manasnagaraj.com} & Mobile: \href{tel:+918788229782}{+91-8788229782} \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Engineering; GPA: 4.00}{Aug 2024}
    \resumeSubheading
      {Savitribai Phule Pune University}{Pune, India}
      {Bachelor of Technology in Computer Engineering; GPA: 3.46 (8.31/10.0)}{Aug 2018 -- July 2022}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Ethereum Foundation}{Remote, WO}
      {Protocol Reseach Fellow}{Jun 2024 -- Present}
      \resumeItemListStart
        \resumeItem{Rated List DHT}
          {Rated List DHT is an improved distribute hash table being purpose built for Ethereum's implementation of data availability sampling. Working on the implementation and performance analysis of the Rated List DHT}
        \resumeItem{Constantine}
          {Constantine is a cryptographic backend implemented in nim. Working on add Constantine as cryptographic backend in nimbus Eth2.0 client}
      \resumeItemListEnd
